...
defineOptions({ name: 'HeaderMenuGeneral' });
...
const menus = computed(() => {
  const topMenus = [] as App.GlobalMenuOption[];
  forEach(routeStore.menus, item => {
    const obj = cloneDeep(item) as App.GlobalMenuOption;
